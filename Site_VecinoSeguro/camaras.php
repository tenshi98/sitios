...
<html lang="en">
	...
	<body>
		...
		<section class="parallax_window_in short" data-parallax="scroll" data-image-src="img/<?php echo $arrBody['camaras']['img']; ?>" data-natural-width="1400" data-natural-height="350">
			<div id="sub_content_in">
				<div class="container">
					<h1><?php echo $arrBody['camaras']['titulo']; ?></h1>
				</div>
			</div>
		</section>
